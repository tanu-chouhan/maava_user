...
import 'package:maava_delivery/features/refer_earn/presentation/widgets/referral_ticket_card.dart';
import 'package:maava_delivery/features/refer_earn/presentation/widgets/rotating_ticket_border.dart';
import 'package:maava_delivery/features/refer_earn/presentation/widgets/fire_particle_share_button.dart';
import 'package:maava_delivery/features/refer_earn/presentation/widgets/refer_earn_background.dart';
...
class _ReferralTicketResultScreenState extends ConsumerState<ReferralTicketResultScreen>
  ...
  void _shareTicket() {
    ...
    if (stats.referralLink.isNotEmpty) {
      Share.share('Join Suvio as a delivery partner — we both earn! ${stats.referralLink}');
    } else if (stats.referralCode.isNotEmpty) {
      Share.share('Join Suvio as a delivery partner. Use my referral code: ${stats.referralCode}');
    } else {
