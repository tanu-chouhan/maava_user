...
class _SplashScreenState extends ConsumerState<SplashScreen>
  ...
  void _setupSuperSmoothAnimations() {
    ...
    _animationController.forward().then((_) => _resolveDestination());
  }
              ...
              return Transform.scale(
                ...
                child: ClipPath(
                  ...
                  child: Container(
                    ...
                    color: Theme.of(
                      context,
                    ).colorScheme.primary, // Adapted to food app primary color
                  ),
                ),
              );
            },
          ...
          children: List.generate(3, (index) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: Theme.of(
                  context,
                ).colorScheme.primary.withOpacity(0.25 + (scaleOpacity * 0.75)),
              ),
            );
          }),
        );
