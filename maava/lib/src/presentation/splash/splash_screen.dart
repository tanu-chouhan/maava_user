...
import 'package:maava/src/core/services/update_service.dart';
  ...
  void _setupSuperSmoothAnimations() {
    ...
    _animationController.forward().then((_) {
      Future.delayed(const Duration(milliseconds: 500), () {
        if (mounted) {
          // Reopen in the vertical (Food / Quick) the user last used.
          context.go(homePathFor(ref.read(appModeProvider)));
        }
      });
    });
  }
