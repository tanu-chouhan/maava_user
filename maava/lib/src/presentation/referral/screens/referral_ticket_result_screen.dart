  ...
  void _shareTicket() {
    ...
    final msg = details?.shareText.isNotEmpty == true
        ...
        : (details?.referralLink.isNotEmpty == true
            ? (rewardStr.isEmpty
                ? 'Join me on MAAVA! ${details!.referralLink}'
                : 'Join me on MAAVA and get $rewardStr off on your first order! ${details!.referralLink}')
            : 'Join MAAVA as a user. Use my referral code: $code');
