...
class AboutScreen extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionTitle('Why Choose MAAVA?', isDark),
  ...
  /// 1. Hero Card: MAAVA Logo + Subtitle + Headline + Description + 3D Illustration
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // Description
                Text(
                  'MAAVA is your trusted food delivery platform, connecting you with the best restaurants, cafés and food partners. Fresh meals, quick delivery and delightful experiences – all at your fingertips.',
                  style: TextStyle(
                    fontSize: 11.sp,
                    height: 1.35,
                    color: secondaryTextColor,
  ...
  /// 4. Why Choose MAAVA Card (6 Features Grid)
  ...
  Widget _buildCompanyInfoCard(
    ...
    final items = [
      {'icon': Icons.label_outlined, 'title': 'Company Name', 'value': 'MAAVA', 'isLink': false},
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'Thank you for being a part of MAAVA!',
                  style: TextStyle(
                    fontSize: 12.5.sp,
                    fontWeight: FontWeight.bold,
                    color: textColor,
