...
/// Central App Constants for MAAVA User Application.
class AppConstants {
  const AppConstants._();

  static const String title = 'MAAVA';
  static const String appName = 'MAAVA';
  ...
  static const String brandName = 'MAAVA';
  ...
  /// Backend REST API host domain — the merged MAAVA backend (maava-new),
  /// served by nginx on maava.in: /api → :5100, /socket.io → :5101, /uploads
  /// static. The vertical (/v1/food vs /v1/quick) is chosen per path.
