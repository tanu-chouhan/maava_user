...
class ApiPaths {
  ...
  /// Banners for the ₹99 Store. The backend calls this rail "under-250";
  /// the app brands it "99 Store" — same admin-managed creatives.
  static const String store99Banners = '/food/hero-banners/under-250/public';
