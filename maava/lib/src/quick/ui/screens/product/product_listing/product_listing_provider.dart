...
/// fetched so far.
class ProductListingController extends Notifier<ProductListingState> {
  ProductListingController(this.arg);

  /// The listing arguments (Riverpod 3 passes the family argument here).
  final ProductListingArgs arg;
