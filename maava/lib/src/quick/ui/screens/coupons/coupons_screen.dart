  ...
  Future<void> _apply(Coupon coupon) async {
    ...
    switch (outcome) {
      case CouponApplied(:final savings):
        // Hand the win back to the cart and let *it* celebrate: the popup
        // belongs on the screen the user returns to, and showing it from here
        // would mean driving a dialog off a context this route is about to
        // dispose.
        context.pop(CouponWin(code: coupon.code, savings: savings));
