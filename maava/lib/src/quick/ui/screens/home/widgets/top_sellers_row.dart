            ...
            SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // Open/closed, not a marketplace rank: these outlets all
                  // belong to the same company, so ranking them against each
                  // other ("Top Seller") is meaningless to the customer.
                  // Whether they can order right now is not.
                  Positioned(
                    left: 6,
                    top: 6,
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: seller.acceptingOrders
                            ? context.colors.primary
                            : const Color(0xFF6B7280),
                        borderRadius: BorderRadius.circular(6),
                      ),
                      child: Text(
                        seller.acceptingOrders ? 'Open' : 'Closed',
                        style: context.text.labelSmall!.copyWith(
                          fontWeight: FontWeight.w800,
                          fontSize: 8.5,
                          color: Colors.white,
