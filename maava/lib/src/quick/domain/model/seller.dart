...
class Seller {
  ...
  /// Used when merging the backend's seller row with the product preview
  /// derived from the catalogue — the list endpoint cannot return either.
  Seller copyWith({List<Product>? products, int? productCount}) => Seller(
        id: id,
        name: name,
        imageUrl: imageUrl,
