  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          // 1. Top Yellow Header with Appzeto Logo & Action Buttons
    ...
    return SliverAppBar(
      ...
      title: Row(
        children: [
          ...
          // Center: Appzeto Logo & Groceries in 10 Mins
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
          ...
          _headerActionBtn(
            ...
            iconColor: isWishlisted ? context.semantic.danger : context.colors.onSurface,
          ...
          _headerActionBtn(
            ...
            onTap: () => Share.share(
              '${product.name} on Appzeto — ${product.price.asCurrency}\n'
              '${ShareLinks.product(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? context.semantic.warningSoft : context.colors.surface,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            _specRow(context, 'Brand', product.brand),
            _specRow(context, 'Pack size', product.packSize),
            _specRow(context, 'Category', product.categoryName),
            _specRow(
              context,
              'Food type',
              product.isVeg ? 'Vegetarian' : 'Non-vegetarian',
            ),
            _specRow(context, 'Sold by', product.sellerName),
          ],
        ),
      ),
    );
